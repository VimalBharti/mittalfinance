                  ...
                  <tbody class="divide-y divide-gray-200 dark:divide-neutral-700">
                    ...
                    >
                      <td class="size-px whitespace-nowrap align-center">
                        <NuxtLink :to="`/client/${client.id}`" class="block p-4">
                          <div class="flex items-center gap-x-4">
                            <img class="shrink-0 w-16 h-16 rounded-lg" :src="client.photo" alt="Product Image">
                          </div>
                        </NuxtLink>
                      </td>
                      <td class="size-px whitespace-nowrap align-center">
                        <NuxtLink :to="`/client/${client.id}`" class="block p-4" href="#">
                          <span class="block text-sm text-gray-800 dark:text-neutral-200">{{client.serialnumber}}</span>
                        </NuxtLink>
                      </td>
                      <td class="size-px whitespace-nowrap align-center">
                        <NuxtLink :to="`/client/${client.id}`" class="block p-4" href="#">
                      ...
                      <td class="size-px whitespace-nowrap align-center">
                        <NuxtLink :to="`/client/${client.id}`" class="block p-4" href="#">
                          <span class="block text-sm text-gray-500 dark:text-neutral-500">₹ {{client.emiAmount}}</span>
                        </NuxtLink>
                      </td>
                      <td class="size-px whitespace-nowrap align-center">
                        <NuxtLink :to="`/client/${client.id}`" class="block p-4" href="#">
                          <span class="text-sm text-gray-600 dark:text-neutral-400">{{client.salaryCreditDate}}</span>
                        </NuxtLink>
                      </td>
                      <td class="size-px whitespace-nowrap align-center">
                        <NuxtLink :to="`/client/${client.id}`" class="block p-4 text-sm" href="#">
                          ₹ {{ client.loanAmount }}
                        </NuxtLink>
                      </td>
                    </tr>
