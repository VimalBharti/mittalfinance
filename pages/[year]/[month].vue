                ...
                <div class="bg-white overflow-hidden dark:bg-neutral-900 dark:border-neutral-700">
                  ...
                  <div class="px-6 py-4 grid gap-3 md:flex md:justify-between md:items-center border-b border-gray-200 dark:border-neutral-700">
                    ...
                    <div class="sm:col-span-1">
                      <h3 class="font-bold flex items-center gap-2 bg-gray-900 text-white rounded-xl py-2 px-4">
                        <Icon name="material-symbols:calendar-month-rounded" class="h-6 w-6" />
                        {{currentMonthName}}
                      </h3>
                    </div>
                    <!-- End Input -->
                  ...
                  <div class="grid grid-cols-2 gap-12 p-6">
                    <!-- recievedLoans -->
                    <section class="rounded-xl border-2 overflow-y-auto border-green-200 h-[76vh]">
                      <table class="min-w-full divide-y divide-green-200">
                        ...
                        <tbody class="divide-y divide-green-200 rounded-xl">
                          <tr 
                            class="bg-white hover:bg-green-50 cursor-pointer"
                            v-for="loan in recievedLoans" :key="loan"
                          >
                    ...
                    <!-- pendingLoans -->
                    <section class="shadow rounded-xl border-2 overflow-y-auto border-red-200 h-[76vh]">
                      <table class="min-w-full divide-y divide-red-200">
                        ...
                        <tbody class="divide-y divide-red-200">
                          <tr 
                            class="bg-white hover:bg-red-50 cursor-pointer"
                            v-for="loan in pendingLoans" :key="loan"
                          >
                            <td class="size-px whitespace-nowrap align-center">
                              <NuxtLink :to="`/client/${loan.client_id}`" class="block p-4">
                                <span class="block text-sm text-gray-800 dark:text-neutral-200">{{loan.file_number}}</span>
...
const fetchPendingLoans = async () => {
  ...
  onMounted(fetchReceivedLoans(), fetchPendingLoans())
